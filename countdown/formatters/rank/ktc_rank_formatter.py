#KTC website format is ugly af for this one

import csv
import pandas as pd

ktc_in_name = 'KTC_in.csv'
ktc_out_name = 'KTC_out.csv'
    ...
    with open(ktc_out_name, 'w') as ktc_out_file:
        ...
        for line in ktc_reader:
            ...
            if(line_count in wanted):
                ...
                if(string_line[0] == 'R' and line_count == 3):
                     curr_csv_line.append('RB')
                elif(string_line[0] == 'W' and line_count == 3):
                     curr_csv_line.append('WR')
                elif(string_line[0] == 'Q' and line_count == 3):
                     curr_csv_line.append('QB')
                elif(string_line[0] == 'T' and line_count == 3):
